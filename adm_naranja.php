...
// Consulta para obtener los productos que estén en naranja
$query = "SELECT * FROM add_product WHERE cantidad > cantidad_minima AND cantidad <= cantidad_maxima";
...
<html>
<head>
    <title>Productos en Naranja</title>
...
<body>
    ...
    <div class="container">
        <h1 style="text-align: center; margin-bottom: 20px; width: 100%;">Productos en Naranja</h1>
    </div>
    <div class="container">
        <table id="productos-table" style="width: 100%; border-collapse: collapse;">
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td style="text-align: center; width: 10%; color: orange;"><?php echo $row['cantidad']; ?></td>
