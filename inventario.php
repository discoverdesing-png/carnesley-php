...
<body>
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
            ...
            <td style="padding: 0; width: 10%;"><?php echo $row['cantidad_minima']; ?></td>
            <td style="padding: 0; width: 10%;"><?php echo $row['cantidad_maxima']; ?></td>
            <td style="padding: 0; width: 10%;"><?php echo $row['excedente']; ?></td>
        </tr>
    <?php } ?>
</table>
